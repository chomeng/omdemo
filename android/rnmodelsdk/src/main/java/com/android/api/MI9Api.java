...
//                    if(granted){
//                        Logc.e("1.requestPermissions.权限成功============" + granted);
//                        SpManager.getInstance().init(activity,"conf");
//                    }else{
//                        Logc.e("1.requestPermissions.权限失败=========" + granted);
//                    }
