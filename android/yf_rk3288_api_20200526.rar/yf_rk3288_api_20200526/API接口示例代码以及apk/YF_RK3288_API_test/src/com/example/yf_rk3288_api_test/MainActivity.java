package com.example.yf_rk3288_api_test;
...
public class MainActivity extends Activity {
	...
	public Button bt1,bt2,bt3,bt4,bt5,bt6,bt7,bt8,bt9,bt9_1,bt10,bt11,bt12,bt13,bt14,bt15,bt16,bt17,bt18,bt19,bt20,bt21;
	...
	private void displaybttest(){
		...
		bt21.setOnClickListener(new OnClickListener() { 
			...
			public void onClick(View v) {
				if(flag_1==0){
					flag_1=1;
				yfapi.yfsetEthonoff(false);		
				}
				else {
					flag_1=0;
				yfapi.yfsetEthonoff(true);		
				}
			}
		});
